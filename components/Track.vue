...
const isActive = computed(() => {
  return (
    playerStore.currentTrack && playerStore.currentTrack._id === props.track._id
  );
});
...
const coverUrl = computed(() => {
  ...
  if (typeof logo === "object" && logo.data && logo.data.url)
    return logo.data.url;
  return null;
});
